...
const Update = () => {
  ...
  const handleProceedToPayment = () => {
    ...
    console.log("Proceeding to payment with manual location:", {
      streetName,
      apartment,
      city,
      pincode,
          ...
          <div className="flex flex-col space-y-6 ">
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <div className="flex-1 text-center">
                  <span className="text-xl font-bold">Delivery Date</span>
                </div>
            ...
            <div className={`w-full border bg-third p-4 transition-all duration-300 ease-in-out ${isLocationExpanded ? "h-auto border-b-2" : "h-24"}`}>
              <div className="flex items-center justify-between">
                ...
                <div className="flex-1 text-center">
                  <span className="text-xl font-bold">Location Update</span>
                </div>
                <ExpandCircleDownRoundedIcon
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <div className="flex-1 text-center">
                  <span className="text-xl font-bold">Choose Payment</span>
                </div>
                <ExpandCircleDownRoundedIcon
